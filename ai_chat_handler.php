...
$knowledgeBase = [
    ...
    [
        ...
        'response' => '<strong>VHEcoPoint Rates and Limits:</strong><br><ul><li><strong>Plastic (PET Bottles <=1000ml):</strong> 0.303 pts per gram</li><li><strong>Aluminum Cans:</strong> 0.303 pts per gram</li><li><strong>Paper &amp; Cardboard:</strong> 0.303 pts per gram</li><li><strong>Point value:</strong> 1 point = Php 0.30 in amenity value</li><li><strong>Daily limit:</strong> 3 sessions and 100 points per day</li><li><strong>Weekly cap:</strong> 250 points, resetting every Monday at 12:00 AM</li><li><strong>Maximum balance:</strong> 3,000 points</li><li><strong>Expiry:</strong> Points expire after 24 months</li></ul>Points are credited automatically after a successful VHEcoPoint deposit in VictorianPass.'
    ],
