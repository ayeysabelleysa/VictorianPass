...
if ($session) {
    ...
    $sessionOut = [
        ...
        'total_weight_kg'   => (float)($session['weight_kg'] ?? 0),
        'points_calculated' => (float)($session['points_calculated'] ?? 0),
        'points_awarded'    => (float)($session['points_awarded'] ?? 0),
        'total_points'      => (float)($session['points_calculated'] ?? 0),
