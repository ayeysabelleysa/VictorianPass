...
<head>
  ...
  <title>VictorianEcoPoint Station Display</title>
...
<body>
    ...
    <div class="topbar" aria-hidden="true">
      <div class="brand">
        ...
        <div class="brand-title">
          <strong>VictorianEcoPoint Station</strong>
      ...
      <section class="screen is-active" id="screen-idle" aria-label="Idle screen">
        <div class="fit-root">
          <div class="card">
            ...
            <h1 class="title">VictorianEcoPoint</h1>
          ...
          <div class="footer-actions">
            <button class="btn btn-ghost" id="learnBtn" type="button">Learn About VictorianEcoPoint</button>
          </div>
        </div>
      </section>
  ...
  <div class="modal" id="infoModal" role="dialog" aria-modal="true" aria-label="VictorianEcoPoint information">
    <div class="modal-panel">
      <div class="modal-panel-inner" id="modalFit">
        <h2 class="modal-title">Learn About VictorianEcoPoint</h2>
        <p class="modal-sub">
          VictorianEcoPoint is Victorian Heights Subdivision's Smart Waste Segregation Station that automatically sorts your recyclables and rewards you with points redeemable for free amenity bookings.
        </p>
            ...
            <ul class="list">
              ...
              <li>
                ...
                <div class="text">
                  ...
                  <span>Keep redeeming to make the most of VictorianEcoPoint.</span>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div class="modal-nav" id="modalNav" aria-label="VictorianEcoPoint info pages">
